class Pet < ActiveRecord::Base
	...
	validates :secondaryType, inclusion: { in: %w(none poison fire water electric grass rock ground psychic ice flying dragon fighting ghost normal steel dark bug), 
